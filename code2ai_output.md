...
<mujocoinclude>
    ...
    <asset>
      ...
      <material name="peg_block_green" rgba="0 0.8 0 1" shininess="0.5" specular="0.5"/>
...
<mujocoinclude>
      <body childclass="peg_block_base">
            ...
            <geom type="box" conaffinity="0" contype="0" group="1" material="peg_block_green"
                  size="0.03 0.007071 0.005"
                  pos="0 -0.101 0.165"
                  euler="-45 0 0"/>
            ...
            <geom type="box" conaffinity="0" contype="0" group="1" material="peg_block_green"
                  size="0.007071 0.005 0.03"
                  pos="-0.035 -0.101 0.13"
                  euler="0 0 45"/>
...
<mujoco>
    ...
    <worldbody>
      <include file="./xyz_base.xml"/>
        ...
        <body name="peg" pos="0 0.6 0.03">
          ...
          <site name="pegGrasp" pos=".0 .0 .01" size="0.005" rgba="0.8 0 0 1"/>
        </body>
    ...
    <equality>
        <weld body1="mocap" body2="hand" solref="0.0001 1"></weld>
    </equality>
